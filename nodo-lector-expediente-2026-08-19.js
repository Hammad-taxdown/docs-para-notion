...
const expediente = {
  ...
  // 19/08/2026 · FUERA fecha_llamada. Ya no se pregunta (al reservar en Calendly el
  // cliente recibe la cita con su fecha), el validador ya no escribe la columna y el
  // parametro sale de la tool. Devolverla aqui solo reintroduciria la idea.
