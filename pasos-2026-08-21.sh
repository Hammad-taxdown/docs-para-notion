#!/bin/bash
# Los pasos del 21/08. YA ESTAN HECHOS LOS 2 PRIMEROS (nodo pegado y publicado en
# c4e05e77, prompt v13 con el tag prod movido). Se conserva como registro.
# Los pasos de HOY estan en docs/pasos.sh.
